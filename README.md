...
|----------|-------------|---------------|
| `dataset_001` | Dataset_001 is a comprehensive collection of data ... | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/AMGrobelnik/ai-invention-dkw-bounds-enable-principled-fusionfission-control/blob/main/dataset_001/demo/data_demo.ipynb) |
| `experiment_001` | This experiment, denoted as experiment_001, utiliz... | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/AMGrobelnik/ai-invention-dkw-bounds-enable-principled-fusionfission-control/blob/main/experiment_001/demo/method_demo.ipynb) |
| `evaluation_001` | The evaluation artifact labeled 'evaluation_001' a... | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/AMGrobelnik/ai-invention-dkw-bounds-enable-principled-fusionfission-control/blob/main/evaluation_001/demo/eval_demo.ipynb) |

### Formal Proofs

| Artifact | Description | Verify in Lean |
|----------|-------------|----------------|
| `proof_001` | The proof (ID: proof_001) provides a foundational ... | [![Verify in Lean](https://img.shields.io/badge/Lean_4-Verify_Proof-blue)](https://live.lean-lang.org/#codez=--CsguSkgA) |

### Findings & Documentation

| Artifact | Description | View Finding |
|----------|-------------|--------------|
| `finding_001` | This artifact presents a novel finding that contri... | [![View Finding](https://img.shields.io/badge/View-Finding-green)](https://github.com/AMGrobelnik/ai-invention-dkw-bounds-enable-principled-fusionfission-control/blob/main/finding_001/demo/finding_001.md) |
