...
|----------|-------------|---------------|
| `dataset_001` | Dataset_001 comprises a comprehensive collection o... | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/AMGrobelnik/ai-invention-dkw-bounds-enable-principled-fusionfission-control/blob/main/dataset_001/demo/data_demo.ipynb) |
| `experiment_001` | Experiment_001 investigates a specific hypothesis ... | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/AMGrobelnik/ai-invention-dkw-bounds-enable-principled-fusionfission-control/blob/main/experiment_001/demo/method_demo.ipynb) |
| `evaluation_001` | The evaluation artifact (evaluation_001) assesses ... | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/AMGrobelnik/ai-invention-dkw-bounds-enable-principled-fusionfission-control/blob/main/evaluation_001/demo/eval_demo.ipynb) |

### Formal Proofs

| Artifact | Description | Verify in Lean |
|----------|-------------|----------------|
| `proof_001` | This proof artifact demonstrates a fundamental the... | [![Verify in Lean](https://img.shields.io/badge/Lean_4-Verify_Proof-blue)](https://live.lean-lang.org/#codez=--CsguSkgA) |

### Findings & Documentation

| Artifact | Description | View Finding |
|----------|-------------|--------------|
| `finding_001` | This finding reveals critical data regarding the i... | [![View Finding](https://img.shields.io/badge/View-Finding-green)](https://github.com/AMGrobelnik/ai-invention-dkw-bounds-enable-principled-fusionfission-control/blob/main/finding_001/demo/finding_001.md) |
